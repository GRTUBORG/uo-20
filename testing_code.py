...
def callback_inline(call):
    if call.message:
        if call.data == 'adress_1':
            ...
            url_button = types.InlineKeyboardButton(text = f"Открыть полное расписание ↗️", url = 'https://bit.ly/3cxSxEV')
